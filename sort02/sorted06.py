...
print('\nThe list of company gear looks like: ', company_gear)
print('\nThe list of company gear sorted by name looks like: ', vendor_name_cg)
print('\nThe Previous list sorted again by year looks like: ', vendor_name_year_cg)
